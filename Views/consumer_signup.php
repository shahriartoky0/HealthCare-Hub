...
<html lang="en">
  ...
  <body>
    <h1 align="center">Sign Up as a Consumer</h1>
    <h3><a href="../home.html">Healthcare Hub</a></h3>
    <form action="../Controllers/con_signup_check.php" method="post" onsubmit= "return validateContactNumber()">
      <table align="center">
        <tr>
          <td>Your Name :</td>
          <td>
        ...
        <tr>
          <td colspan='2' align="center" id="password-strength">
     ...
     <td colspan='2' align="center">
       ...
       <tr>
        ...
        <!-- 
        Here the policy has to be implemented -->
        <tr>
        <td>
  ...
  function validateContactNumber() {
      ...
      const email = document.getElementById('email').value;
        ...
        if (terms.checked== false)
          {
            alert('you must Agree with the agreements')
            return false ;
          }
