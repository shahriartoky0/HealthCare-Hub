...
<html lang="en">
  ...
  <h1 align="center"> Welcome to <a href="../home.html" style="text-decoration:none;"> Healthcare Hub</a></h1>
      <h3 align="center">Login as a Provider</h3>
    <table align="center">
      <tr>
        <td id="message"> 
      ...
      <tr>
        <td>
           <br> If you are new please <a href="provider_signup.php">Sign Up</a>
        </td>
      </tr>
    </table>
  </body>
     ...
     function ajax()
    {
       ...
       {  
         ...
         // alert(user);
          ...
          xhttp.open('POST', '../Controllers/provider_login_check.php', true);
          ...
          xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
              ...
              if (user.state == 'success') {
                window.location.href ='provider_page.php';
              }
